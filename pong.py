...
Ai = pygame.Rect(10,screen_height/2-70,10,140)
...
while True:
    ...
    pygame.draw.rect(screen,light_grey, Ai) 
    ...
    Ai_text = game_font.render(f"{Ai_score}", False,light_grey)
    screen.blit(Ai_text,(600,470))
